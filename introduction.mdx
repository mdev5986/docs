---
title: Introduction
description: "Welcome to the home of HeyVoiceFlow documentation"
---
...
## What is HeyVoiceFlow?

HeyVoiceFlow is a robust platform designed for building Voice AI agents. It offers a comprehensive suite of tools and features that empower developers to create sophisticated voice-interactive applications. 

This platform simplifies the process of integrating voice capabilities into various applications, making it an ideal choice for developers looking to enhance user interaction through voice technology.

Voice AI agents in HeyVoiceFlow come pre-equipped with a foundational knowledge base that allows them to understand and respond to a wide range of topics and user queries. This pre-knowledge is continuously updated and refined to ensure that the agents remain up-to-date with the latest information and trends. 

This foundational layer significantly enhances the responsiveness and relevance of the interactions, making the agents more effective right out of the box.

<img
  style={{ borderRadius: '0.8rem' }}
  src="images/app_preciew.png"
  alt="HeyVoiceFlow Logo"
/>
...
HeyVoiceFlow leverages several cutting-edge technologies to provide a seamless and efficient voice interaction experience. Here are the main technologies used:

#### <a href="https://freeswitch.org/">FreeSWITCH</a>
...
#### <a href="https://www.ragknowledge.com/">RAG Knowledge</a>
...
#### <a href="https://www.deepgram.com/">Deepgram</a>
